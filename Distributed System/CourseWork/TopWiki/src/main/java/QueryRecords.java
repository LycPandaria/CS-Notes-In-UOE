...
public class QueryRecords {
    ...
    private static Logger log = Logger.getLogger("log-partA");
    ...
    public static void main(String[] args) throws Exception{
        ...
        FileHandler fileHandler = new FileHandler("../log/log-partA.txt");
        ...
        try(Ignite ignite = Ignition.start()){
            IgniteCache<String, Long> stmCache = ignite.getOrCreateCache(CacheConfig.RecordCache());
